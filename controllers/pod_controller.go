...
//+kubebuilder:rbac:groups=keti-metric.keti-exascale.keti-metric,resources=pods,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=keti-metric.keti-exascale.keti-metric,resources=pods/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=keti-metric.keti-exascale.keti-metric,resources=pods/finalizers,verbs=update
